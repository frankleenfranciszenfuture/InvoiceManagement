...
import { setInvoiceTemplate } from "../../../../slices/invoices/invoiceSlice";
import invoiceTemplates from "../../template/invoiceTemplateRegistry";
        ...
        <div className="grid grid-cols-2 gap-6 p-6">
          {invoiceTemplates.map((t) => {
            ...
            return (
              <div
                key={t.id}
                className={`group relative cursor-pointer overflow-hidden rounded-lg border-2 transition-all duration-200 ${isActive
              ...
              >
                ...
                {/* Title */}
                <div
                  className={`border-t p-4 text-center font-medium transition-colors ${isActive ? "bg-blue-50 text-blue-600" : "text-gray-700"
                    }`}
                >
                  {t.title}
                </div>
