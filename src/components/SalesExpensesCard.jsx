...
import { setFiscalPeriod } from "../../../invoice/src/slices/dashboardSlice";
import {
  LineChart,
  Line,
  XAxis,
...
export default function SalesExpensesCard() {
  const { totalSales, totalReceipts, totalExpenses, chartData } = useSelector(
    (state) => state.dashboard.salesAndExpenses,
  );
